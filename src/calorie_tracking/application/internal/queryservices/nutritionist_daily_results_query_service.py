...
from src.calorie_tracking.application.internal.queryservices.daily_intake_summary_query_service import (
    DailyIntakeSummaryQueryService,
)
from src.profile.domain.repositories.profile_repository import ProfileRepository


class NutritionistDailyResultsQueryService:
    """
    ...
    def __init__(
        ...
        daily_summary_query_service: DailyIntakeSummaryQueryService,
    ):
        self.profile_repository = profile_repository
        self.daily_summary_query_service = daily_summary_query_service
    ...
    def get_patient_summaries_for_day(
        ...
        for patient in patients:
            try:
                summary = self.daily_summary_query_service.get_daily_summary(
